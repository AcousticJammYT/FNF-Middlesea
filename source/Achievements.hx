...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Rhythm Doctor",			"Beat the tutorial on Hard with no Misses.",			'tutorial_nomiss',		false],
		["A Happy Reunion",			"Beat Chapter 1 on Hard with no Misses.",			'ch1_nomiss',			false],
		["Right Back At Ya!",			"Beat Chapter 2 on Hard with no Misses.",			'ch2_nomiss',			false],
		["Connectifa Abortus",			"Beat the finale on Hard with no Misses.",			'finale_nomiss',		false],
		["Daily Treatments",			"Get the good ending in the finale.",				'good_end',			false],
		["Missing You",				"Get the bad ending in the finale.",				'bad_end',			false]
	];
